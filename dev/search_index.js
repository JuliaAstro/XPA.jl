...

{
    ...
    "title": "XPA.list",
    "category": "function",
    "text": "XPA.list(xpa=XPA.connection())\n\nyields a list of available XPA access points.  The result is a vector of XPA.AccessPoint instances.  Optional argument xpa is a persistent XPA client connection (created by XPA.Client); if omitted, a per-thread connection is used (see XPA.connection).\n\nSee also XPA.Client, XPA.connection and XPA.find.\n\n\n\n\n\n"
},
